...
$(document).ready(function(){
	$("#same").on("click",function(){
		var name=$("#mname").val();
		var post=$("#mpost").val();
		var addr1=$("#maddress1").val();
		var addr2=$("#maddress2").val();
...
<%
	MemberDTO user=(MemberDTO)request.getAttribute("login");
	...
	int num=cart.getNum();
	String gCode=cart.getgCode();
	String gName=cart.getgName();
	int gPrice=cart.getgPrice();
	String gSize=cart.getgSize();
	String gColor=cart.getgColor();
	int gAmount=cart.getgAmount();
	String gImage=cart.getgImage();
	System.out.println("user값:"+user+"cart 값:"+cart);
		...
		<tr>
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="td_default" width="80" align="right"><%=num %></td>
					...
					<tr>
						<td height="30"></td>
						<td colspan="2" class="td_default" align="right">총 결제 금액 :<%=gPrice*gAmount %>원</td>
						<td class="td_default" align="right"><%=gPrice %></td>
						<td class="td_default" align="right"><%=gAmount %></td>
					</tr>
				</table> 
				<tr>
					<td>
